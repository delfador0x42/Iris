...
#ifndef COM_WUDAN_IRIS_DNS_EXTENSION_SWIFT_H
#define COM_WUDAN_IRIS_DNS_EXTENSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="com_wudan_iris_dns_extension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP28com_wudan_iris_dns_extension23DNSExtensionXPCProtocol_")
@protocol DNSExtensionXPCProtocol
...
SWIFT_CLASS("_TtC28com_wudan_iris_dns_extension22DNSExtensionXPCService")
@interface DNSExtensionXPCService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class NSXPCListener;
@class NSXPCConnection;
@interface DNSExtensionXPCService (SWIFT_EXTENSION(com_wudan_iris_dns_extension)) <NSXPCListenerDelegate>
...
@interface DNSExtensionXPCService (SWIFT_EXTENSION(com_wudan_iris_dns_extension)) <DNSExtensionXPCProtocol>
- (void)getStatusWithReply:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nonnull))reply;
- (void)getQueriesWithLimit:(NSInteger)limit reply:(void (^ _Nonnull)(NSArray<NSData *> * _Nonnull))reply;
- (void)clearQueriesWithReply:(void (^ _Nonnull)(BOOL))reply;
- (void)setEnabled:(BOOL)enabled reply:(void (^ _Nonnull)(BOOL))reply;
...
SWIFT_CLASS("_TtC28com_wudan_iris_dns_extension16DNSProxyProvider")
