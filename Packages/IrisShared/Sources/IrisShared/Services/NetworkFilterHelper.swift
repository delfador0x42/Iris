...
/// Helper for managing the network filter configuration
@MainActor
public struct NetworkFilterHelper {

    private static let logger = Logger(subsystem: "com.wudan.iris", category: "NetworkFilterHelper")
