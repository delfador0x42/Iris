...
/// Manages the DNS proxy configuration.
/// Follows the same pattern as NetworkFilterManager.
...
@MainActor
public struct DNSProxyManager {

  private static let logger = Logger(subsystem: "com.wudan.iris", category: "DNSProxyManager")
